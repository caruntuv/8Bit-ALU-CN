//8 bit subtractor using full adders
//implements a-b using two s complement
module subtractor_8bit (
  //invert b and add 1 to perform subtraction
  //basically transform subtraction to addition
    input  wire [7:0] A,
    input  wire [7:0] B,
    input  wire       enable,
